...
- **You start with 8 health**. <br /> Increase it by 2 for each point of vitality.
- **You start with 8 willpower**. <br /> Increase it by 1 for each point of intelligence and 2 for each point of mind.
...
- **Martial Pursuit:** You were trained to chase down and kill your foes.
  - **Berserker's Frenzy:** Whenever you wound or kill an enemy, you may immediately perform an additional attack action against any viable target without spending **STA**. You cannot perform a move action before this attack. This effect can trigger multiple times per round.
  - **Raider's Cruelty:** Whenever you wound an enemy, you may choose any result lower on the injury table instead of the injury rolled. You still treat the injury as the injury level rolled if you take advantage of this feature. Whenever you kill an enemy, all targets in a close burst 1 gain the frightened condition.
...
- **Shatter:** Requires a two-handed weapon and a single target. Whether the attack hits or misses, creatures in a close burst 1 of the target besides yourself, take 2 damage.
