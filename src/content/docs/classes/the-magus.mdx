...
The Magus class has access to the magus exit feature, magus rituals feature, magus shield feature, cantrip feature, and spell attack attribute feature.
...
You can apply an attribute to a standard spell attack at the cost of 3 **WIL**. The maximum number of spell attributes you can apply to an attack is equal to your level.
