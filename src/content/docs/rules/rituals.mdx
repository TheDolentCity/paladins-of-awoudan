...
The target chooses one wound they suffer from. The target heals the selected wound. If the check is a failure this ability cannot be attempted again for that wound.
