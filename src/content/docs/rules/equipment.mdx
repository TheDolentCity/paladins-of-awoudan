...
<Tags>
  <Tag>SLA: d8+DEX</Tag>
  <Tag type="secondary">RAN: 1</Tag>
  <Tag type="secondary">ENC: 1</Tag>
  <Tag type="secondary">PRO: Throw 4</Tag>
</Tags>
...
<Tags>
  ...
  <Tag type="secondary">RAN: 1</Tag>
  <Tag type="secondary">ENC: 1</Tag>
  <Tag type="secondary">PRO: Cruel 2</Tag>
</Tags>
...
<Tags>
  ...
  <Tag>SLA: d8+DEX</Tag>
  <Tag type="secondary">RAN: 1</Tag>
  <Tag type="secondary">ENC: 3</Tag>
  <Tag type="secondary">PRO: 2H, Cruel 4</Tag>
</Tags> */}

### Reading the table

- **Name:** Name of the weapon.
- **CRU:** The attack roll for crushing attacks.
...
- **Requirements:** You must meet the following ability score requirements to wield the weapon.
- **Properties:** Unique effects that modify the weapon.

| Name                 | CRU     | PRC     | SLA     | RAN | ENC | Requirements | Properties         |
| -------------------- | ------- | ------- | ------- | --- | --- | ------------ | ------------------ |
| Short Spear          | d4      | d6+DEX  | d4      | 1   | 1   | DEX 1        | Throw 6        |
...
| Ranger's Short Knife | d4      | d4+DEX  | d4+DEX  | 1   | 1   | DEX 1        | Quick, Throw 6 |
...
| Throwing Axe         | d4      | d4      | d8+DEX  | 1   | 1   | DEX 2        | Throw 4        |
...
| Holy Symbol   | d4+SPI | 1+SPI | 0   | SPI 2        | Magic, Holy, Worn  |
...
- **CRU:** Reduce crush attack rolls by this value.
- **PRC:** Reduce pierce attack rolls by this value.
- **SLA:** Reduce slash attack rolls by this value.
...
| Name                    | CRU | PRC | SLA | FOC | ENC | SPE | Requirements | Properties                |
| ----------------------- | --- | --- | --- | --- | --- | --- | ------------ | ------------------------- |
| Clothing                | -2  | -0  | -0  | -0  | 0   | +0  |              |                           |
| Light armor             | -4  | -2  | -2  | -0  | 2   | +0  | STR 0        |                           |
| Medium armor            | -2  | -6  | -6  | -0  | 4   | -1  | STR 1        |                           |
| Heavy armor             | -2  | -10 | -10 | -0  | 6   | -2  | STR 2        |                           |
| Consecrated heavy armor | -2  | -8  | -8  | -2  | 5   | -2  | STR 2, SPI 1 |                           |
| Consecrated armor       | -1  | -4  | -4  | -4  | 3   | -1  | STR 1, SPI 2 |                           |
| Consecrated robes       | -2  | -0  | -0  | -8  | 0   | +0  | SPI 1        |                           |
| Sable robes             | -2  | -0  | -0  | -6  | 0   | +0  | ARC 2        | Shroud 1                  |
| Ranging cloak           | -2  | -0  | -0  | -0  | 0   | +0  | DEX 2        | Skill: Wilderness Stealth |
| Shield                  | -0  | -1  | -1  | -0  | 1   | +0  | STR 1        | Shielding                 |
| Heavy shield            | -1  | -2  | -2  | -0  | 2   | +0  | STR 3        | Shielding                 |
